...
#ifndef FOKUS_SWIFT_H
#define FOKUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Fokus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC5Fokus11AppDelegate")
...
@class CALayer;
@class NSCoder;
SWIFT_CLASS("_TtC5Fokus19NSPlayerViewWrapper")
@interface NSPlayerViewWrapper : NSView
